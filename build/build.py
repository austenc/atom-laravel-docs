...
for url in sorted(set(links)):
    ...
    url = 'https://laravel.com/docs/' + slug
...
# Build laravel-docs.js file
with open('../lib/laravel-docs.js', 'w+') as f:
    f.write("'use babel';\n\n")
...
print('Laravel Docs - Package files have been built.')
